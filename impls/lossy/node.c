...
/* ======================================================================
 *  LAB SCENARIO 2 — hybrid topology, LOSSY links        (REQUIRED)
 * ----------------------------------------------------------------------
 *  Graded by:  testcase_stp_convergence_hybrid_lossy
 *  Links:      each link independently drops packets (default 50% per
 *              link; you can set the MIXNET_LOSS env var to play around
 *              with other loss rates).                  
 *  Goal:       minimize the number of STP control messages exchanged
 *              before the spanning tree converges.
 *
 *  Build & measure locally:   ./impls/run_impl.sh lossy
